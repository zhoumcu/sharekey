...
/**
 * author：Administrator on 2017/4/13 13:11
 * company: xxxx
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final boolean DEFAULT_ISPASSWORDTRANSFORMACTION = false;
    ...
    private boolean mIsPasswordTransformation;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIsPasswordTransformation= ta.getBoolean(R.styleable.gridPasswordView_gpvIsPasswordTransformation, DEFAULT_ISPASSWORDTRANSFORMACTION);
